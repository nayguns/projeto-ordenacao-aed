/*
    Centro Universitario de Goias - Uni-Anhanguera
...
#define SIZEARRAY 1500000
#define LIMITRAND 90000


//Menu
int menuPrograma();
void menuProgramaAciona(int opcao, unsigned long int *arrayCalled, unsigned long int limitRand);
...
//Chamadas do Menu
void chamadaBubbleSort(unsigned long int *array, int limitRand);
void chamadaInsertionSort(unsigned long int *array, int limitRand);
void chamadaSelectionSort(unsigned long int *array, int limitRand);
void chamadaHeapSort(unsigned long int *array, int limitRand);
void chamadaQuickSort(unsigned long int *array, int limitRand);
void chamadaMergeSort(unsigned long int *array, int limitRand);
void chamdaShellSort(unsigned long int *array, int limitRand);
void chamadaImprimirArray(unsigned long int *array, int limitRand);
void chamadaPreencherArray(unsigned long int *array, int limitRand);
...
int main(void){
    ...
    do {
        ...
        menuProgramaAciona(opcaoSelect, emptyArray, limitRand);
    }
    while(opcaoSelect != 0);
...
void menuProgramaAciona(int opcao, unsigned long int *arrayCalled, unsigned long int limitRand){
    ...
    switch(opcao)
    {
        ...
        case 1:
            chamadaPreencherArray(arrayCalled, limitRand);
        break;

        case 2:
            chamadaBubbleSort(arrayCalled, limitRand);
        break;

        case 3:
            chamadaInsertionSort(arrayCalled, limitRand);
        break;

        case 4:
            chamadaSelectionSort(arrayCalled, limitRand);
        break;

        case 5:
            chamadaHeapSort(arrayCalled, limitRand);
        break;

        case 6:
            chamadaQuickSort(arrayCalled, limitRand);
        break;

        case 7:
            chamadaMergeSort(arrayCalled, limitRand);
        break;

        case 8:
            chamdaShellSort(arrayCalled, limitRand);
        break;

        case 9:
            chamadaImprimirArray(arrayCalled, limitRand);
        break;
...
//Chamada aos metodos
void chamadaPreencherArray(unsigned long int *arrayCalled, int limitRand) {
    preencherArray(arrayCalled, SIZEARRAY, limitRand);
    printf("\n    Array preenchido com %d posicoes!\n\n\n", SIZEARRAY);
}


void chamadaBubbleSort(unsigned long int *arrayCalled, int limitRand){
    clock_t timer;
...
void chamadaInsertionSort(unsigned long int *arrayCalled, int limitRand){
    clock_t timer;
...
void chamadaSelectionSort(unsigned long int *arrayCalled, int limitRand){
    clock_t timer;
...
void chamadaHeapSort(unsigned long int *arrayCalled, int limitRand) {
    clock_t timer;
...
void chamadaQuickSort(unsigned long int *arrayCalled, int limitRand) {
    clock_t timer;
...
void chamadaMergeSort(unsigned long int *arrayCalled, int limitRand) {
    clock_t timer;
...
void chamdaShellSort(unsigned long int *arrayCalled, int limitRand) {
    clock_t timer;
...
void chamadaImprimirArray(unsigned long int *arrayCalled, int limitRand) {
    if (checarArrayVazio(arrayCalled, SIZEARRAY, limitRand) == 1) {
...
//Funcao para imprimir o array preenchido
void imprimirArray(unsigned long int *array, int sizeArray){
...
//Funcao para checar Array cheio
int checarArrayVazio(unsigned long int *array, int sizeArray, unsigned long int limit){
    unsigned long int countA;
    for(countA = 0; countA < sizeArray; countA++){
